...
$h_j = \hat{\sigma}_j / 2$: OBS! EN REALIDAD ES EL DESVIO DEL LOGARITMO DE LAS $X_j$.
```{r bandwidths}
...
```{r pred3}
#pdf('pred3.pdf', bg='transparent')
#png('pred3.png', bg='transparent')
#png('pred3-white.png')
...
#pdf('tmspeclean.pdf', bg='transparent')
#png('tmspeclean.png', bg='transparent')
png('tmspeclean-white.png')
boxplot(tmspe.ro, tmspe.gam, names=c('Robust', 'Classical'),
        col=rep(c('tomato3', 'gray80'), 2), main='Trimmed MSPE On "clean" data')
dev.off()
#pdf('nontmspeclean.pdf', bg='transparent')
#png('nontmspeclean.png', bg='transparent')
png('nontmspeclean-white.png')
...
![Trimmed MSPE On "clean" data \label{fig:tmspeclean}](tmspeclean.png){ width=85% }
![Non-Trimmed MSPE On "clean" data \label{fig:nontmspeclean}](nontmspeclean.png){ width=85% }
